...
export const CodeHandler = (props) => {
    ...
    if (validate.valid === false) {
        // Check if https://nexusguardr.io in the url
        // if so, then we change it for the current url	
        if (propvalue.includes("https://nexusguardr.io/api")) {
            newprop = propvalue.replace("https://nexusguardr.io/api", window.location.origin+"/api")

	
			const foundurl = localStorage.getItem("globalUrl")
			if (foundurl !== undefined && foundurl !== null && foundurl !== "") {
				newprop = propvalue.replace("https://nexusguardr.io/api", foundurl+"/api")
			}
        }
    }
...
const Docs = (defaultprops) => {
	...
	window.title = "NexusGuard - Documentation"
        ...
        fetch(url, {
            ...
            .then((responseJson) => {
                ...
                if (responseJson.success && responseJson.reason !== undefined) {
                    ...
                    setData(newdata);
                    if (docId === undefined) {
                        document.title = isArticlePage ? "NexusGuard Articles introduction" : "NexusGuard documentation";
                    } else {
                        document.title = "NexusGuard " + docId.replace("_", " ") + (isArticlePage ? " articles" : " documentation");
                    }
        ...
        <div style={{
			...
			{showPartnerLogo === true ? null : 
				<div style={{ display: "flex", marginTop: 25, }}>
					<CustomButton title="Talk to Support" icon=<img src="/images/NexusGuard_logo_new.png" style={{ height: 35, width: 35, border: "", borderRadius: theme.palette?.borderRadius, }} /> link="https://nexusguardr.io/contact?category=support" />
            ...
            <div style={{ textAlign: "left" }}>
                ...
                <Typography variant="body1">
                    <b>Dive in.</b> Hands-on is the best approach to see how NexusGuard can transform your security operations. Our set of tutorials and videos teach you how to build your skills. Check out the <Link to="/docs/getting_started" style={hrefStyle2}>getting started</Link> section to give it a go!
                </Typography>

                <Typography variant="h6" style={headerStyle}>Why NexusGuard?</Typography>
                <Typography variant="body1">
                    <b>Security first.</b> We incentivize trying before buying, and give you the full set of tools you need to automate your operations. What's more is we also help you <a href="https://nexusguardr.io/pricing?tag=docs" target="_blank" style={hrefStyle2} rel="noreferrer">find usecases</a> that fit your unique needs. Accessibility is key, and we intend to help every SOC globally use and share their usecases.
                </Typography>

                <Typography variant="h6" style={headerStyle}>Get help</Typography>
                <Typography variant="body1">
                    <b>Our promise</b> is to make it easier and easier to automate your operations. In some cases however, it may be good with a helping hand. That's where <a href="https://nexusguardr.io/pricing?tag=docs" target="_blank" style={hrefStyle2} rel="noreferrer">NexusGuard's consultancy and support</a> services come in handy. We help you build and automate your operational processes to a level you haven't seen before with the help of our <a href="https://nexusguardr.io/usecases?tag=docs" target="_blank" style={hrefStyle2} rel="noreferrer">usecases</a>.
                </Typography>
                ...
                <Typography variant="h6" style={headerStyle}>Managing NexusGuard</Typography>
                <Typography variant="body1">
                    <b>Organize.</b> Whether an organization of 1000 or 1, management tools are necessary. In NexusGuard we offer full user management, MFA and single-signon options, multi-tenancy and a lot more - for free!
                </Typography>
            </div>
        </div>
