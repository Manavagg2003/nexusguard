...
const Priorities = memo((props) => {
	...
	const generateCommsNotificationWorkflow = async (app, sender, recepient) => {
		...
		var workflowDescription = "Generated by NexusGuard for sending info/error notifications."
		var data = {
			"name": workflowName,
			...
			<div style={{ maxHeight: 1700, overflowY: "auto", width: '100%', scrollbarColor: theme.palette.scrollbarColorTransparent, scrollbarWidth: 'thin' }}>
				...
				{orgSaveButton}
					...
					<Typography variant="body2" color="texSecondary" style={{ fontSize: 16, marginLeft: clickedFromOrgTab ? null : 25, }}>
						Suggestions are tasks identified by NexusGuard to help you discover ways to protect your and customers' company. <br />These range from simple configurations in NexusGuard to Usecases you may have missed.&nbsp;
						<a
							target="_blank"
							rel="noopener noreferrer"
